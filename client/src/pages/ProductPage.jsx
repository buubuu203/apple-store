              ...
              <div>
                ...
                <div className="mt-3 flex select-none flex-wrap items-center gap-1">
                  {product.Colors.map((color) => (
                    <label
                      onClick={() => (colorRef.current = color)}
                      className=""
                      key={color}
                    >
                      <input
                      ...
                      />
                      <p className="transition-all ease-linear duration-200 peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">
                        {color}
                      </p>
                    </label>
                  ))}
